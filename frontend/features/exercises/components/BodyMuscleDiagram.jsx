...
function FrontBody({ primary, secondary, accent }) {
  ...
  return (
    <svg viewBox="0 0 200 440" role="img" aria-label="Vista frontal del cuerpo">
      ...
      {/* Deltoides: anterior + lateral, como cabezas separadas */}
      ...
      {/* Pecho: superior / mayor / inferior, como 3 bandas */}
      ...
      {/* Abdomen: recto superior / inferior */}
      ...
      {/* Cuadriceps + aductores (cara interna) */}
      ...
      {/* Pantorrillas (vista frontal, simplificado) */}
  ...
  return (
    <div className="body-diagram">
      <div className="body-diagram-toggle">
        <button type="button" className={view === "front" ? "is-active" : ""} onClick={() => setView("front")}>Frontal</button>
        <button type="button" className={view === "back" ? "is-active" : ""} onClick={() => setView("back")}>Posterior</button>
      </div>
      {view === "front"
