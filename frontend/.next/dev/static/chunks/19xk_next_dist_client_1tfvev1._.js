...
function schedulePrefetchTask(key, treeAtTimeOfPrefetch, fetchStrategy, priority, onInvalidate, navigationLockPrefetch) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        const { getNavigationLockSegmentCacheMap } = __turbopack_context__.r("[project]/frontend/node_modules/next/dist/client/components/segment-cache/navigation-testing-lock.js [app-client] (ecmascript)");
            ...
            case 2:
                if (task.phase === 2) {
                    ...
                    if (("TURBOPACK compile-time value", true) && task._navigationLockPrefetch != null) {
                        ...
                        const { resolveNavigationLockPrefetch } = __turbopack_context__.r("[project]/frontend/node_modules/next/dist/client/components/segment-cache/navigation-testing-lock.js [app-client] (ecmascript)");
